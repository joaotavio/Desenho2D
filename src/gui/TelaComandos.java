...
public class TelaComandos extends JDialog implements ActionListener{
    ...
    private void addTexto(){
        ...
        addLabel(new JLabel("Botão direito do mouse: Desenhar"), panel);
        addLabel(new JLabel("Botão esquerdo do mouse: Selecionar"), panel);
        ...
        addLabel(new JLabel("ESC: Cancelar desenho"), panel);
